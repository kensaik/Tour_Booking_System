...
- Name: guest-booking.spec.ts >> Guest booking — happy path >> guest browses → selects departure → checks out → sees confirmation
- Location: e2e\guest-booking.spec.ts:12:3
