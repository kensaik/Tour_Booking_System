...
test.describe('Company tour CRUD', () => {
  ...
  test('company can add a new tour and see it in /company/tours list', async ({
    page,
  }) => {
    ...
    // Tên Tour
    await page
      .getByPlaceholder(/tour đà lạt 3 ngày 2 đêm/i)
      .fill(tourName)
    ...
    // Mô tả tổng quát
    await page
      .getByPlaceholder(/giới thiệu sơ lược về tour/i)
      .fill('Mô tả E2E test')
