...
export default function Toast({ message, type, onClose, duration = 3000 }: ToastProps) {
  ...
  const getBgColor = () => {
    switch (type) {
      case "success":
        return "border-secondary/20 bg-surface-container-highest shadow-secondary/5";
      case "error":
        return "border-error/20 bg-surface-container-highest shadow-error/5";
      default:
        return "border-primary/20 bg-surface-container-highest shadow-primary/5";
    }
  };
