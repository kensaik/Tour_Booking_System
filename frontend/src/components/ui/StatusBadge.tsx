import { BOOKING_STATUS, PAYMENT_STATUS, TOUR_STATUS, COMPANY_STATUS, DEPARTURE_STATUS } from '@/lib/status'
...
const STATUS_MAP: Record<StatusType, Record<string, { label: string; colorClass: string; icon?: any }>> = {
