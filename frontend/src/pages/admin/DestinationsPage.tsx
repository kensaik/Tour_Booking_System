    ...
    <AdminLayout>
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-outline-variant">
                  <span className="text-xs text-on-surface-variant">#{dest.id}</span>
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-on-surface mb-1">Tên điểm đến *</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="block text-sm font-medium text-on-surface mb-1">Mô tả</label>
            <textarea
              rows={3}
        ...
        {selectedDestination && (
          <div className="space-y-4">
            ...
            <div className="p-4 bg-surface-container rounded-xl">
              <p className="text-xs text-on-surface-variant uppercase font-bold tracking-wider mb-2">
                Mô tả
              </p>
