...
import { Mail, Lock, Eye, EyeOff, User, Phone, ArrowLeft, CheckCircle, Building2 } from "lucide-react";
        ...
        <div className="bg-surface/95 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-outline-variant">
          {isSuccess ? (
            <div className="text-center py-4">
              ...
              <h2 className="text-2xl font-bold text-on-surface mb-2">Đăng ký thành công!</h2>
              <p className="text-on-surface-variant mb-8">
                {formData.role === "COMPANY"
                  ? "Tài khoản đối tác của bạn đã được gửi đi. Vui lòng đợi quản trị viên phê duyệt trước khi bắt đầu kinh doanh."
                  : "Chào mừng bạn đến với TourGo. Tài khoản của bạn đã được khởi tạo thành công."}
              </p>
              <Link
                to="/login"
                className="block w-full bg-primary hover:bg-primary/90 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200"
              >
                Đăng nhập ngay
              </Link>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {formData.role === "COMPANY" && (
                  <div className="animate-in fade-in slide-in-from-top-2">
                    <label htmlFor="companyName" className="block text-sm font-medium text-on-surface mb-2">
                      Tên công ty / Đơn vị lữ hành
                    </label>
                    <div className="relative">
                      <Building2 className="absolute left-3 top-1/2 -translate-y-1/2 text-on-surface-variant w-5 h-5" />
                      <input
                        id="companyName"
                        name="companyName"
                        type="text"
                        ...
                        required
                        placeholder="Công ty Du lịch TourGo"
