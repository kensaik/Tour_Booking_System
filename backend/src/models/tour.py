...
from src.constants import TourStatus, DepartureStatus
...
class Tour(db.Model):
    ...
    itineraries = db.relationship('TourItinerary', backref='tour', lazy='dynamic', cascade="all, delete-orphan", order_by="TourItinerary.day_number")
    departures = db.relationship('Departure', backref='tour', lazy='dynamic', cascade="all, delete-orphan")
